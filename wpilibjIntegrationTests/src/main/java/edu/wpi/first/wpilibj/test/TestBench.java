...
public final class TestBench {
  ...
  public MotorEncoderFixture<Talon> getTalonPair() {
    MotorEncoderFixture<Talon> talonPair =
        new MotorEncoderFixture<Talon>() {
          @Override
  ...
  public MotorEncoderFixture<Victor> getVictorPair() {
    MotorEncoderFixture<Victor> vicPair =
        new MotorEncoderFixture<Victor>() {
          @Override
  ...
  public MotorEncoderFixture<Jaguar> getJaguarPair() {
    MotorEncoderFixture<Jaguar> jagPair =
        new MotorEncoderFixture<Jaguar>() {
          @Override
  ...
  public TiltPanCameraFixture getTiltPanCam() {
    TiltPanCameraFixture tpcam =
        new TiltPanCameraFixture() {
          @Override
  ...
  public static AnalogCrossConnectFixture getAnalogCrossConnectFixture() {
    AnalogCrossConnectFixture analogIO =
  ...
  public static RelayCrossConnectFixture getRelayCrossConnectFixture() {
    RelayCrossConnectFixture relay =
        new RelayCrossConnectFixture() {
          @Override
