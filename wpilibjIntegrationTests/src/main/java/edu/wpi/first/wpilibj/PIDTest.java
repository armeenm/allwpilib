...
public class PIDTest extends AbstractComsSetup {
  ...
  public void setUp() throws Exception {
    ...
    m_runner =
        new PIDControllerRunner(m_controller, me.getEncoder()::getDistance, me.getMotor()::set);
  ...
  public void testInitialSettings() {
    ...
    assertEquals(
        "PID.getError() did not start at " + reference, reference, m_controller.getError(), 0);
  ...
  public void testSetSetpoint() {
    ...
    m_runner.enable();
    assertEquals(
        "Did not correctly set reference", reference, new Double(m_controller.getSetpoint()));
  }
