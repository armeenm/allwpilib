...
public abstract class InterruptableSensorBase extends SendableBase {
   ...
   *     InterruptHandlerFunction#onInterrupt(boolean, boolean)} that will be called whenever there
   *     is an interrupt on this device. Request interrupts in synchronous mode where the user
   *     program interrupt handler will be called when an interrupt occurs. The default is interrupt
