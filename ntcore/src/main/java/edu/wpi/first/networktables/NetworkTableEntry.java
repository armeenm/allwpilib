  ...
  public boolean setDefaultValue(Object defaultValue) {
    if (defaultValue instanceof NetworkTableValue) {
      ...
      switch (((NetworkTableValue) defaultValue).getType()) {
        case kBoolean:
          return NetworkTablesJNI.setDefaultBoolean(
              m_handle, time, ((Boolean) otherValue).booleanValue());
        case kDouble:
  ...
  public boolean setValue(Object value) {
    if (value instanceof NetworkTableValue) {
      ...
      switch (((NetworkTableValue) value).getType()) {
        case kBoolean:
          return NetworkTablesJNI.setBoolean(
              m_handle, time, ((Boolean) otherValue).booleanValue(), false);
        case kDouble:
